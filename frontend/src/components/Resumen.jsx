...
export default function Resumen({ helados, setActiveTab }) {
  ...
  return (
    <div className="space-y-8 animate-fade-in">
      <div>
        <h2 className="text-2xl font-bold tracking-tight text-white font-display">Balance Operacional</h2>
        <p className="text-slate-300 text-sm">Estado logístico de la pizarra en tiempo real.</p>
      </div>

      {/* Tarjetas de Métricas */}
      <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
        
        <div className="bg-white/95 backdrop-blur-md border-2 border-white p-6 rounded-2xl shadow-xl shadow-blue-950/50 flex items-center justify-between">
          <div>
        ...
        <div className="bg-white/95 backdrop-blur-md border-2 border-white p-6 rounded-2xl shadow-xl shadow-blue-950/50 flex items-center justify-between">
          <div>
            <span className="text-xs font-bold text-red-500 uppercase tracking-wide">Faltantes</span>
      ...
      <div className="mt-10 bg-gradient-to-r from-green-700 to-green-600 rounded-2xl p-6 text-white shadow-lg flex flex-col md:flex-row justify-between items-start md:items-center gap-4">
        <div>
          <h3 className="font-bold text-lg font-display">Auditar stock</h3>
        ...
        <button 
          ...
          className="bg-gradient-to-r from-red-600 to-red-700 hover:from-red-700 hover:to-red-800 text-white px-5 py-2.5 rounded-xl font-bold text-sm transition-all shadow-md flex-shrink-0"
        >
